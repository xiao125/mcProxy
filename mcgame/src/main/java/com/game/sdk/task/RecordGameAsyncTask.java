...
public class RecordGameAsyncTask extends AsyncTask<Map<String, String>, Void, Void>  {

	private Context context = null;
	private String loginUrl = null;
	private Handler handler = null;

	public RecordGameAsyncTask(Context context, Handler handler, String loginUrl) {
	...
	protected Void doInBackground(Map<String, String>[] params) {
		...
		KnLog.log("loginUrl : " + this.loginUrl+  "   RecordGameAsyncTask params = " + params[0] );
		for (int i = 0; i < 3; i++) {
