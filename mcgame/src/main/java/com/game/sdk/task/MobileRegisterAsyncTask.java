...
public class MobileRegisterAsyncTask extends
	...
	public MobileRegisterAsyncTask(Context context, Handler handler, String regUrl) {
	...
	protected Void doInBackground(Map<String, String>[] params) {
		KnLog.i("regUrl : " + this.regUrl+ "MobileRegisterAsyncTask params = " + params[0]);
		...
		for (int i = 0; i < 3; i++) {
			...
			try {
				...
				if (result == null) {
					...
					KnLog.log("手机号注册返回的参数："+obj.toString());
					...
					/*	JSONObject content = new JSONObject(
						...
						msg.what = ResultCode.MOBILE_REG_SUCCRESS;
						break;


					default:
						msg.what = ResultCode.MOBILE_REG_FAIL;
						break;
					}
