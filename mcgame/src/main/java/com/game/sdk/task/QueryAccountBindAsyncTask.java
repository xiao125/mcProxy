...
public class QueryAccountBindAsyncTask extends AsyncTask<Map<String, String>, Void, Void>  {
	
	private Context context = null;
	private String loginUrl = null;
	private Handler handler = null;
	
	public QueryAccountBindAsyncTask(Context context, Handler handler,String loginUrl) {
			...
			try {
				 ...
				 if(result == null){
					...
					case ResultCode.SUCCESS:
						...
						KnLog.log("返回的参数：手机号是："+msg.obj.toString());

						break;
					default:
						msg.what = ResultCode.QUERY_ACCOUNT_BIND_FAIL;
						break;
					}
