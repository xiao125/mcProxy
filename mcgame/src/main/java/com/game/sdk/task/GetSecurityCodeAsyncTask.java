...
public class GetSecurityCodeAsyncTask extends AsyncTask<Map<String, String>, Void, Void>  {
	
	private Context context = null;
	private String loginUrl = null;
	private Handler handler = null;
	
	public GetSecurityCodeAsyncTask(Context context, Handler handler,String loginUrl) {
			...
			try {
				 ...
				 if(result == null){
					...
					case ResultCode.SUCCESS:
						 ...
						 msg.what = ResultCode.SECURITY_SUCCESS;
						break;
					default:
						msg.what = ResultCode.SECURITY_FAIL;
						break;
					}
