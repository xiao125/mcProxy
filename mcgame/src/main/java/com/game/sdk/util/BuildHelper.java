...
/**
 * Build类获取手机制造商，系统定制商，型号，Android 系统版本
 */
    ...
    public static void getAllBuildInformation() {
        ...
        for (Field field : fields) {
            try {
                ...
                KnLog.log("Build." + field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                KnLog.log("an error occured when collect crash info:"+ e);
            }
        }
        ...
        for (Field field : fieldsVersion) {
            try {
                field.setAccessible(true);
                KnLog.log("Build.VERSION." + field.getName() + " : " + field.get(null));
            } catch (Exception e) {
                KnLog.log("an error occured when collect crash info:"+ e);
            }
        }
